...
public class RecommendationController {
	...
	private ResponseEntity<List<Recommendation>> getAllRating(@RequestParam("productId") Long productId) {
	...
	private ResponseEntity<Recommendation> saveRecommendations(
		...
		// Vẫn dùng Product và User để kiểm tra xem ID có thật sự tồn tại bên kia không
		if (product != null && user != null) {
			try {
				Recommendation recommendation = new Recommendation();
				recommendation.setProductId(productId); // Gán ID thay vì Object
				recommendation.setUserId(userId); // Gán ID thay vì Object
